...
namespace Donor.Controllers
{
    public class RequestsController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Name,Phone,District,Thana,Address,RecipientType,PreviewesHealthProblem,BoodGroup,RecentDrag,Others,Approved,RequestDate,Id,CreatedDate")] Request request)
        {
            if (id != request.Id)
            {
                return NotFound();
